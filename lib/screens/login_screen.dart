...
/*
  This widget is used to display the login screen
  It takes the email and password as input and logs in the user
*/
class LoginScreen extends StatelessWidget {
  ...
  /*
    ...
    It validates the form and logs in the user
  */
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (!isSuccess) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              TextConstants.icorrectPasswordText,
      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Lottie.asset(ImageConstant.loginLottie, height: 200),
              Column(
